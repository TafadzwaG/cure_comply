...
@php
    ...
    $workspaceLabel = $workspaceName ?? ($tenant?->name ?: 'Privacy Cure Compliance');
@endphp
    ...
    <div style="max-width:700px;margin:0 auto;border:1px solid rgba(195,198,209,0.35);border-radius:18px;overflow:hidden;background:#ffffff;box-shadow:0 26px 64px -42px rgba(0,39,83,0.30);">
        ...
        <div style="padding:32px;">
            ...
            <div style="margin-bottom:26px;">
                <div style="font-size:12px;letter-spacing:0.16em;text-transform:uppercase;font-weight:700;color:#737781;margin-bottom:12px;">Invitation details</div>
                    ...
                    <tr>
                        <td style="width:33.333%;padding-right:10px;vertical-align:top;">
                            <div style="height:100%;border:1px solid rgba(195,198,209,0.32);border-radius:16px;padding:18px;background:#ffffff;">
                                ...
                                <div style="margin-top:12px;font-size:15px;font-weight:700;color:#002753;">Accept the invitation</div>
                                <div style="margin-top:8px;font-size:13px;line-height:1.7;color:#5b616a;">Use the secure button below to open the invitation acceptance page.</div>
                            </div>
                        </td>
                        <td style="width:33.333%;padding:0 5px;vertical-align:top;">
                            <div style="height:100%;border:1px solid rgba(195,198,209,0.32);border-radius:16px;padding:18px;background:#ffffff;">
                                ...
                                <div style="margin-top:12px;font-size:15px;font-weight:700;color:#002753;">Complete setup</div>
                                <div style="margin-top:8px;font-size:13px;line-height:1.7;color:#5b616a;">Confirm your account details and finish the first access flow for your role.</div>
                            </div>
                        </td>
                        <td style="width:33.333%;padding-left:10px;vertical-align:top;">
                            <div style="height:100%;border:1px solid rgba(195,198,209,0.32);border-radius:16px;padding:18px;background:#ffffff;">
                                ...
                                <div style="margin-top:12px;font-size:15px;font-weight:700;color:#002753;">Enter the workspace</div>
                                <div style="margin-top:8px;font-size:13px;line-height:1.7;color:#5b616a;">Start working inside {{ $isPlatformInvitation ? 'the platform admin workspace' : $workspaceLabel }} with the assigned access level.</div>
                            </div>
                        </td>
                    </tr>
                </table>
