...
<div style="width:100%;padding:32px 16px;background:#eef2f6;">
    <div style="max-width:700px;margin:0 auto;border:1px solid rgba(195,198,209,0.35);border-radius:18px;overflow:hidden;background:#ffffff;box-shadow:0 26px 64px -42px rgba(0,39,83,0.30);">
        ...
        <div style="padding:32px;">
            ...
            <div style="margin-bottom:26px;">
                <div style="font-size:12px;letter-spacing:0.16em;text-transform:uppercase;font-weight:700;color:#737781;margin-bottom:12px;">Next steps</div>
                <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td style="width:33.333%;padding-right:10px;vertical-align:top;">
                            <div style="height:100%;border:1px solid rgba(195,198,209,0.32);border-radius:16px;padding:18px;background:#ffffff;">
                                ...
                                <div style="margin-top:12px;font-size:15px;font-weight:700;color:#002753;">Review submitted responses</div>
                                <div style="margin-top:8px;font-size:13px;line-height:1.7;color:#5b616a;">Open the assessment and confirm the submitted answers align with the control requirements.</div>
                            </div>
                        </td>
                        <td style="width:33.333%;padding:0 5px;vertical-align:top;">
                            <div style="height:100%;border:1px solid rgba(195,198,209,0.32);border-radius:16px;padding:18px;background:#ffffff;">
                                ...
                                <div style="margin-top:12px;font-size:15px;font-weight:700;color:#002753;">Check supporting evidence</div>
                                <div style="margin-top:8px;font-size:13px;line-height:1.7;color:#5b616a;">Validate uploaded evidence and identify any gaps or clarifications needed before final review.</div>
                            </div>
                        </td>
                        <td style="width:33.333%;padding-left:10px;vertical-align:top;">
                            <div style="height:100%;border:1px solid rgba(195,198,209,0.32);border-radius:16px;padding:18px;background:#ffffff;">
                                ...
                                <div style="margin-top:12px;font-size:15px;font-weight:700;color:#002753;">Advance the workflow</div>
                                <div style="margin-top:8px;font-size:13px;line-height:1.7;color:#5b616a;">Move the submission into review decisions, scoring updates, or any follow-up action required by your process.</div>
                            </div>
                        </td>
                    </tr>
                </table>
