...
Route::get('training/{course:slug}', [PublicTrainingController::class, 'show'])->name('training.show');
Route::post('training/{course:slug}/acknowledgements', [PublicTrainingController::class, 'acknowledge'])->name('training.acknowledgements.store');
...
Route::middleware(['auth', 'throttle:api', 'tenant', 'impersonation.audit'])->group(function () {
    ...
    Route::middleware('tenant.active')->group(function () {
        ...
        Route::middleware('employee.profile.complete')->group(function () {
            ...
            Route::get('reports/public-training-acknowledgements', [ReportController::class, 'publicTrainingAcknowledgements'])->name('reports.public-training-acknowledgements');
